...
public record BasicSchedule(TransactionType transactionType, String trainUid,
                            LocalDate dateRunsFrom, @Nullable LocalDate dateRunsTo,
                            Set<DayOfWeek> daysRun,
                            com.joshuaharwood.cifparser.parsing.lines.model.BasicSchedule.BankHolidayRunning bankHolidayRunning,
                            com.joshuaharwood.cifparser.parsing.lines.model.BasicSchedule.TrainStatus trainStatus,
