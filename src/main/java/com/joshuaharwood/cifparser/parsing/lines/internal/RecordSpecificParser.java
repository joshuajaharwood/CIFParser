...
public sealed interface RecordSpecificParser<T extends CifRecord> permits AssociationParser,
  ...
  default @NonNull String required(
    String record,
  ...
  default <E extends Enum<E> & Literal> E requiredLookup(String record,
    Map<?, String> parsedValues,
    String parseKey,
    Class<E> literalType) {
    
    String requiredValue = required(record, parsedValues, parseKey);
