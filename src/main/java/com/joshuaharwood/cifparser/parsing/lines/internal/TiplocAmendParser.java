...
//      ifPresent(parsedValues.get(TiplocAmendFields.NATIONAL_LOCATION_CODE)).orElse(null),
...
//      ifPresent(parsedValues.get(TiplocAmendFields.PO_MCP_CODE)).map(Integer::valueOf).orElse(null),
